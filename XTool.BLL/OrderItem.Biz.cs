...
namespace XTool.BLL
{
    ...
    /// <remarks></remarks>
    public partial class OrderItem : Entity<OrderItem>
    {
        #region 对象操作
            ﻿
        ...
        /// <returns>实体集</returns>
        public static EntityList<OrderItem> Search(Int32 userid, DateTime start, DateTime end, String key, PageParameter param)
        {
