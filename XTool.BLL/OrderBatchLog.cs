...
namespace XTool.BLL
{
    ...
    [DataObject]
    [Description("")]
    [BindIndex("sqlite_master_PK_OrderBatchLog", true, "LogID")]
    [BindIndex("Index_OrderBatchLog_BatchID", false, "BatchID")]
    [BindTable("OrderBatchLog", Description = "", ConnName = "ConnName", DbType = DatabaseType.SQLite)]
    public partial class OrderBatchLog : IOrderBatchLog
    {
        #region 属性
        ...
        #region 字段名
        /// <summary>取得OrderBatchLog字段信息的快捷方式</summary>
        ...
        /// <summary>取得OrderBatchLog字段名称的快捷方式</summary>
        partial class __
        {
            ///<summary></summary>
    ...
    /// <summary>OrderBatchLog接口</summary>
    /// <remarks></remarks>
    public partial interface IOrderBatchLog
    {
        #region 属性
        /// <summary></summary>
        Int32 LogID { get; set; }
